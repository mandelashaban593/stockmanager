...
<p style="text-align:center">Prosper Phones Limited</p>
<p style="text-align:center">P.o Box 1375 Kampala</p>
<p style="text-align:center">Gazaland</p>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="14%"> Product Model</th>
		
			<th width="14%"> Number of pieces </th>
			<th width="14%"> Date Received </th>
			<th width="14%"> Selling Price </th>
			<th width="14%"> Original Price </th>
			<th width="14%"> Qty Left </th>
			<th width="8%"> Total </th>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $db->prepare("SELECT *, price * qty as total FROM products ");
				$result->execute();
